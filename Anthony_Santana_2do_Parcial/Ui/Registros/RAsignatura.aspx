<%@ Page Title="" Language="C#" MasterPageFile="~/Aula.Master" AutoEventWireup="true" CodeBehind="RAsignatura.aspx.cs" Inherits="Anthony_Santana_2do_Parcial.Ui.Registros.RAsignatura" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="text-center">
        <h3 class="page-header text-center">REGISTRO ASIGANATURA <span></span></h3>
    </div>


    <div class="text-center">
        <span class="badge badge-primary">ID Asiganatura</span><br />
        <br />
        ...
        <asp:Button ID="Button1Buscar" CssClass=" btn btn-default" runat="server" Text="Buscar" Height="45px" ValidationGroup="buscar"  Width="97px" OnClick="Button1Buscar_Click" />
        <br />
    ...
    <div class="text-center">
        <span class="badge badge-primary">Descripcion y/o Nombre </span><br />
    ...
    <div class="modal-footer">
        <div class=" text-center">
            ...
            <asp:Button ID="Guardar" CssClass="btn btn-success" runat="server" Text="Guardar" Height="36px" ValidationGroup="guardar" Width="90px" OnClick="Guardar_Click"  />
