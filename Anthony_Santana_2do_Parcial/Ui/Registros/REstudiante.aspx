...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="text-center">
        <h3 class="page-header text-center">REGISTRO ESTUDIANTE <span></span></h3>
    </div>
    ...
    <div class="text-center">
        ...
        <br />
        <br />
        <span class="badge badge-primary">Nombre&nbsp; Estudiante</span><br />
        ...
        <br />
        <span class="badge badge-primary">Nacimiento Estudiante</span><br />
